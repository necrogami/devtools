...
func TestRenderOverrideFullCreds(t *testing.T) {
	c := hostenv.HostCreds{
		...
		KeyboxdSock:    "/run/user/1000/gnupg/S.keyboxd",
		...
		GPGCommonConf:  "/home/u/.gnupg/common.conf",
	...
	wants := []string{
		...
		"/run/user/1000/gnupg/S.keyboxd:/run/host/keyboxd",
		"/home/u/.gnupg/common.conf:/home/dev/.gnupg/common.conf:ro",
